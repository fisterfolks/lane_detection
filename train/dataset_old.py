...
class lanes(Dataset):
    ...
    def __init__(self, root, transform=None, num_classes=5):
    ...
    def __getitem__(self, index):
        ...
        with open(image_path_city(self.root_labels, os.path.splitext(filename)[0]+"_4.png"), 'rb') as f:
            label4 = load_image(f).convert('P')
        with open(image_path_city(self.root_labels, os.path.splitext(filename)[0]+"_5.png"), 'rb') as f:
            label5 = load_image(f).convert('P')
